...
<ul>
  ...
  <li><strong>Technical problem-solving skills</strong>,</li>
  <li>A hands-on understanding of <strong>product development</strong>, and</li>
  <li>A strong foundation in <strong>software and programming</strong> for engineering solutions.</li>
</ul>
...
#### <a href="https://www.elektronikforschung.de/foerderung/nachwuchsfoerderung/cosima" target="_blank">COSIMA</a> Student Competition – <a href="https://www.cosima-mems.de/de/preistraeger/sieger-2019#:~:text=1.-,Preis,-Team%20Poced" target="_blank">1st Place Award</a>
...
<ul>
  <li>Navigate autonomously in a factory setting,</li>
  <li>Avoid collisions,</li>
  <li>Grasp and assemble parts correctly using motion planning and visual servoing.</li>
</ul>
...
<ul>
  ...
  <li>Objective: <strong>friction reduction, cooling, and self-cleaning</strong>.</li>
</ul>
...
Tasks included:
<ul>
  <li>Hardware design (bending sensors, PCB, housing),</li>
  <li>Wireless communication protocol optimization,</li>
  <li>Arduino firmware development, and</li>
  <li>Integration and testing of gesture-based VR control.</li>
</ul>
...
<center>
    <p>
        ...
        <source src="/assets/vid/about/Virtual Reality Practical Course - Winter Term 2017_18 - Cyberglove.mp4">
...
<ul>
   <li>Stay present and purposeful in every task,</li>
   <li>Act fairly and with integrity,</li>
   <li>Maintain discipline in my craft, and</li>
   <li>Embrace challenges with endurance and adaptability.</li>
</ul>
